...
sentence_one = f'{brand_name_one} is made in {manufacturer_country_one}.\nThe price is {retail_price_one} which is\nalmost equal to {usd_to_bdt} BDT'
sentence_two = f'{brand_name_two} is made in {manufacturer_country_two}.\nThe price is {retail_price_two} which is\nalmost equal to {usd_to_bdt_two} BDT'
sentence_three = f'{brand_name_3} is made in {manufacturer_country_3}.\nThe price is {retail_price_3} which is\nalmost equal to {usd_to_bdt_3} BDT'
sentence_four = f'{brand_name_4} is made in {manufacturer_country_4}.\nThe price is {retail_price_4} which is\nalmost equal to {usd_to_bdt_4} BDT'
sentence_five = f'{brand_name_5} is made in {manufacturer_country_5}.\nThe price is {retail_price_5} which is\nalmost equal to {usd_to_bdt_5} BDT'
sentence_six = f'{brand_name_6} is made in {manufacturer_country_6}.\nThe price is {retail_price_6} which is\nalmost equal to {usd_to_bdt_6} BDT'

total_sentence = f'{sentence_one}.\n\n{sentence_two}.\n\n{sentence_three}.\n\n{sentence_four}.\n\n{sentence_five}.\n\n{sentence_six}.'
